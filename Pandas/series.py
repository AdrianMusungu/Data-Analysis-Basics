...
print 'isNull in revenue2:'
print pd.isnull(revenue2)

print 'notNull in revenue2:'
print pd.notnull(revenue2)

#addition of series (+)
print 'addition or revenue+revenue2:'
print revenue+revenue2

#assigning names
revenue2.name="Company Revenues"
revenue2.index.name="Company"

print 'assigning column names to revenue2:'
print revenue2
